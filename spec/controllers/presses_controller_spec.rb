...
describe PressesController do
  ...
  # Press. As you add validations to Press, be sure to
  ...
  # PressesController. Be sure to keep this updated too.
  def valid_session
    {}
  end

  describe "GET index" do
    it "assigns all presses as @presses" do
      press = Press.create! valid_attributes
      get :index, {}, valid_session
      assigns(:presses).should eq([press])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested press" do
        ...
        Press.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the presses list" do
      press = Press.create! valid_attributes
      delete :destroy, {:id => press.to_param}, valid_session
      response.should redirect_to(presses_url)
    end
  end
