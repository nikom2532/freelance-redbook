  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved invitation as @invitation" do
        ...
        post :create, {:invitation => { "fullname" => "invalid value" }}, valid_session
        assigns(:invitation).should be_a_new(Invitation)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested invitation" do
        ...
        Invitation.any_instance.should_receive(:update_attributes).with({ "fullname" => "MyString" })
        put :update, {:id => invitation.to_param, :invitation => { "fullname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the invitation as @invitation" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Invitation.any_instance.stub(:save).and_return(false)
        put :update, {:id => invitation.to_param, :invitation => { "fullname" => "invalid value" }}, valid_session
        assigns(:invitation).should eq(invitation)
      end
